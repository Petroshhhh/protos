...
type LoginResponse struct {
	...
	Token int64 `protobuf:"varint,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the logger in user
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Auth token of the logger in user
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Auth token of the logger in user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x14, 0x70, 0x65, 0x74, 0x72, 0x6f, 0x73, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
